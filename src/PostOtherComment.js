...
function PostOtherComment(props) {
  return (
    <div className="divPostOtherComment flex items-center m-1 dark:text-white dark:text-opacity-80 max-w-5xl">
      <img
      ...
      <div className="flex-grow">
        <div className="flex flex-col">
          <div className="divComment flex flex-col rounded-3xl bg-gray-100 dark:bg-gray-400 dark:bg-opacity-20 p-3 m-2 mb-0">
            <p className="font-medium dark:text-white dark:text-opacity-95">
              {props.name}
            </p>
            <p>{props.text}</p>
          </div>
          <div className="divActionButton flex ml-4 opacity-95">
